        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24">
          ...
          <section className="py-20 text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Link href="/auth/signup">
                <Button size="lg" className="bg-gradient-to-r from-cyan-400 to-cyan-600 hover:bg-gradient-to-r from-cyan-400 to-cyan-600-hover">
                  Start Creating
                </Button>
              </Link>
              <Link href="/#pricing">
          ...
          <section id="features" className="py-20 scroll-mt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="hover:shadow-cyan-lg transition-all duration-300">
                <CardHeader>
          ...
          <section id="pricing" className="py-20 scroll-mt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <Card className="hover:shadow-cyan-lg transition-all duration-300">
                ...
                <CardContent>
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">10 posts/month</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">AI post generation</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">Basic scheduling</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">1 platform connection</span></li>
                  </ul>
                  <Link href="/auth/signup">
              ...
              {/* Pro */}
              <Card className="border-2 border-cyan-500 shadow-cyan-lg relative hover:shadow-cyan-lg transition-all duration-300">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-cyan-600 text-white text-xs font-medium px-3 py-1 rounded-full">Popular</span>
                </div>
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">Unlimited posts</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">All platform connections</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">AI Copilot access</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">Advanced analytics</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">AI image generation</span></li>
                  </ul>
                  <Link href="/auth/signup">
                    <Button className="w-full bg-gradient-to-r from-cyan-400 to-cyan-600 hover:bg-gradient-to-r from-cyan-400 to-cyan-600-hover">Get Started</Button>
                  </Link>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-cyan-lg transition-all duration-300">
                ...
                <CardContent>
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">Everything in Pro</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">Team collaboration</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">Priority support</span></li>
                    <li className="flex items-center gap-2"><Check className="w-5 h-5 text-cyan-600" /><span className="text-gray-300">Custom integrations</span></li>
                  </ul>
                  <Link href="/auth/signup">
